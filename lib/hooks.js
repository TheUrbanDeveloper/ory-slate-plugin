...
var _indentation = require('./plugins/indentation');
...
var _glossary = require('./plugins/glossary');

var _glossary2 = _interopRequireDefault(_glossary);

var _clearformatting = require('./plugins/clearformatting');
...
// FIXME #126
var defaultPlugins = exports.defaultPlugins = [new _paragraph2.default(), new _emphasize2.default(), new _headings2.default({ DEFAULT_NODE: DEFAULT_NODE }), new _link2.default(), new _code2.default({ DEFAULT_NODE: DEFAULT_NODE }), new _lists2.default({ DEFAULT_NODE: DEFAULT_NODE }), new _blockquote2.default({ DEFAULT_NODE: DEFAULT_NODE }), new _glossary2.default({ DEFAULT_NODE: DEFAULT_NODE }), new _alignment2.default(), new _indentation2.default(), new _clearformatting2.default({ DEFAULT_NODE: DEFAULT_NODE })];
