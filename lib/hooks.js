...
export var defaultPlugins = [new ParagraphPlugin(), new EmphasizePlugin(), new HeadingsPlugin({ DEFAULT_NODE: DEFAULT_NODE }), new LinkPlugin(), new CodePlugin({ DEFAULT_NODE: DEFAULT_NODE }), new ListsPlugin({ DEFAULT_NODE: DEFAULT_NODE }), new BlockquotePlugin({ DEFAULT_NODE: DEFAULT_NODE }), new GlossaryPlugin({ DEFAULT_NODE: DEFAULT_NODE }), new AlignmentPlugin(), new IndentationPlugin(), new ClearPlugin({ DEFAULT_NODE: DEFAULT_NODE })];
