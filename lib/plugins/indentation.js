var _jsxFileName = 'src/plugins/indentation.js';
  ...
  function IndentationPlugin() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = IndentationPlugin.__proto__ || Object.getPrototypeOf(IndentationPlugin)).call.apply(_ref, [this].concat(args))), _this), _this.createButton = function (action, icon) {
      return function (_ref2) {
        ...
        return React.createElement(ToolbarButton, { onClick: onClick, icon: icon, __source: {
    ...
    }, _this.name = 'indentation', _this.toolbarButtons = [_this.createButton('indent', React.createElement(IndentIncreaseIcon, {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 57
      },
      __self: this
    })), _this.createButton('unindent', React.createElement(IndentDecreaseIcon, {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 58
      },
