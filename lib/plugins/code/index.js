...
var CodePlugin = function (_Plugin) {
  ...
  function CodePlugin(props) {
    ...
    _this.hoverButtons = [_this.createButton(CODE, React.createElement(CodeIcon, null))];
    _this.toolbarButtons = [_this.createNodeButton(CODE, React.createElement(CodeIcon, null))];
