...
var HeadingsPlugin = function (_Plugin) {
  ...
  function HeadingsPlugin(props) {
    ...
    _this.toolbarButtons = [_this.createButton(H1, React.createElement(H1Icon, {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 69
      },
      __self: this
    })), _this.createButton(H2, React.createElement(H2Icon, {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 70
      },
      __self: this
    })), _this.createButton(H3, React.createElement(H3Icon, {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 71
      },
      __self: this
    })), _this.createButton(H4, React.createElement(H4Icon, {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 72
      },
      __self: this
    })), _this.createButton(H5, React.createElement(H5Icon, {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 73
      },
      __self: this
    })), _this.createButton(H6, React.createElement(H6Icon, {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 74
      },
